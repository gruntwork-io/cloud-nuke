...
func awsNuke(c *cli.Context) error {
	telemetry.TrackEvent(commonTelemetry.EventContext{
		EventName: telemetry.EventStartAWS,
	}, map[string]interface{}{})
	defer telemetry.TrackEvent(commonTelemetry.EventContext{
		EventName: telemetry.EventEndAWS,
	}, map[string]interface{}{})
...
func awsDefaults(c *cli.Context) error {
	telemetry.TrackEvent(commonTelemetry.EventContext{
		EventName: telemetry.EventStartAWSDefaults,
	}, map[string]interface{}{})
	defer telemetry.TrackEvent(commonTelemetry.EventContext{
		EventName: telemetry.EventEndAWSDefaults,
	}, map[string]interface{}{})
...
func awsInspect(c *cli.Context) error {
	telemetry.TrackEvent(commonTelemetry.EventContext{
		EventName: telemetry.EventStartAWSInspect,
	}, map[string]interface{}{})
	defer telemetry.TrackEvent(commonTelemetry.EventContext{
		EventName: telemetry.EventEndAWSInspect,
	}, map[string]interface{}{})
