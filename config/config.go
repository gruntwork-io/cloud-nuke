...
type Config struct {
	...
	SageMakerStudioDomain           SageMakerStudioDomainResourceType `yaml:"SageMakerStudioDomain"`
...
type SageMakerStudioDomainResourceType struct {
	// Note: Include/Exclude filtering is not supported for SageMaker Studio Domain
	// as MLflow tracking servers cannot be filtered by domain
